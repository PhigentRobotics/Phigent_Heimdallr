...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AXI_DATA_STRB" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_DATA_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_ID_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_LEN_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CP" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DP" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DSP48_VER" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IC" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SRC_IMAGE_H" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SRC_IMAGE_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAR_IMAGE_H" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAR_IMAGE_W" -parent ${Page_0}
