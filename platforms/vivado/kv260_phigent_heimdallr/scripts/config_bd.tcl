...
set_property -dict [ apply_preset "" ] $PS_0
...
proc create_hier_cell_capture_pipeline_0 { parentCell nameHier } {
  ...
  # Create instance: phigent imgproc
  set resize_0 [ create_bd_cell -type ip -vlnv phigent.ai:ip:Resize:1.0 resize_0 ]
  set_property -dict [ list \
   CONFIG.SRC_IMAGE_W {2880} \
   CONFIG.SRC_IMAGE_H {1860} \
   CONFIG.TAR_IMAGE_W {1280} \
   CONFIG.TAR_IMAGE_W {960} \
 ] $resize_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins s_axi_ctrl_frmbuf] [get_bd_intf_pins resize_0/S_AXI_CONTROL]
  connect_bd_intf_net -intf_net axis_mipi_img [get_bd_intf_pins mipi_csi2_rx_subsyst_0/video_out] [get_bd_intf_pins resize_0/S_AXIS_IMG]
  ...
  connect_bd_intf_net -intf_net v_frmbuf_wr_1_m_axi_mm_video [get_bd_intf_pins m_axi_mm_video] [get_bd_intf_pins resize_0/M0_IMG_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins aclk] [get_bd_pins resize_0/m_axi_aclk] -boundary_type upper
  ...
  connect_bd_net -net v_frmbuf_wr_1_interrupt [get_bd_pins interrupt] [get_bd_pins resize_0/interrupt]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins resize_0/m_axi_aresetn] [get_bd_pins xlslice_0/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set sensor_trigger [ create_bd_port -dir O sensor_trigger ]
  set gpio_out [ create_bd_port -dir O -from 11 -to 0 gpio_out ]
 ...
 # Create instance: axi_ic_capture
  set axi_ic_capture [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_ic_capture ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
   CONFIG.S00_HAS_REGSLICE {1} \
  ...
  set phigent_trigger [ create_bd_cell -type ip -vlnv phigent.ai:ip:Trigger:1.0 phigent_trigger ]
  set_property -dict [ list \
    CONFIG.TRIGGER_FREQ {30} \
 ] $phigent_trigger
  ...
  connect_bd_intf_net -intf_net axi_interconnect_ctrl_100_M00_AXI [get_bd_intf_pins axi_ic_ctrl_100/M00_AXI] [get_bd_intf_pins capture_pipeline_0/csirxss_s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_ctrl_100_M01_AXI [get_bd_intf_pins axi_ic_ctrl_100/M01_AXI] [get_bd_intf_pins capture_pipeline_1/csirxss_s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_ctrl_100_M02_AXI [get_bd_intf_pins axi_ic_ctrl_100/M02_AXI] [get_bd_intf_pins vcu/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_ctrl_100_M03_AXI [get_bd_intf_pins axi_ic_ctrl_100/M03_AXI] [get_bd_intf_pins phigent_trigger/S_AXI_CONTROL]
  connect_bd_intf_net -intf_net axi_interconnect_ctrl_100_M04_AXI [get_bd_intf_pins axi_ic_ctrl_100/M04_AXI] [get_bd_intf_pins axi_iic_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_capture_M00_AXI [get_bd_intf_pins ${::PS_INST}/S_AXI_HP0_FPD] [get_bd_intf_pins axi_ic_capture/M00_AXI]
  connect_bd_intf_net -intf_net axi_ic_capture_S00_AXI [get_bd_intf_pins capture_pipeline_0/m_axi_mm_video] [get_bd_intf_pins axi_ic_capture/S00_AXI]
  connect_bd_intf_net -intf_net axi_ic_capture_S01_AXI [get_bd_intf_pins capture_pipeline_1/m_axi_mm_video] [get_bd_intf_pins axi_ic_capture/S01_AXI]
  ...
  # connect_bd_intf_net -intf_net ps_IIC_0 [get_bd_intf_pins ${::PS_INST}/IIC_0] [get_bd_intf_ports iic_0]
  connect_bd_intf_net -intf_net ps_CNA_0 [get_bd_intf_pins ${::PS_INST}/CAN_0] [get_bd_intf_ports can_0]
  connect_bd_intf_net -intf_net ps_UART_0 [get_bd_intf_pins ${::PS_INST}/UART_0] [get_bd_intf_ports uart_0]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_ic_ctrl_100/ARESETN] [get_bd_pins proc_sys_reset_100MHz/interconnect_aresetn]
  connect_bd_net -net ${::PS_INST}_emio_gpio_o [get_bd_pins ${::PS_INST}/emio_gpio_o] [get_bd_pins capture_pipeline_0/Din] -boundary_type upper
  connect_bd_net -net ${::PS_INST}_emio_gpio_o [get_bd_pins ${::PS_INST}/emio_gpio_o] [get_bd_pins capture_pipeline_1/Din] -boundary_type upper
  ...
  connect_bd_net -net clk_wiz_0_clk_100M [get_bd_pins ${::PS_INST}/maxihpm0_lpd_aclk] [get_bd_pins phigent_trigger/s_axi_aclk]
  ...
  connect_bd_net -net clk_wiz_0_clk_100M [get_bd_pins ${::PS_INST}/maxihpm0_lpd_aclk] [get_bd_pins capture_pipeline_0/lite_aclk] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_100M [get_bd_pins ${::PS_INST}/maxihpm0_lpd_aclk] [get_bd_pins capture_pipeline_1/lite_aclk] -boundary_type upper
  ...
  connect_bd_net -net clk_wiz_0_clk_200M [get_bd_pins capture_pipeline_0/dphy_clk_200M] [get_bd_pins clk_wiz_0/clk_200M]
  connect_bd_net -net clk_wiz_0_clk_200M [get_bd_pins capture_pipeline_1/dphy_clk_200M] [get_bd_pins clk_wiz_0/clk_200M]
  ...
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_ctrl_300/M01_ACLK] -boundary_type upper
  ...
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_capture/ACLK] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_capture/M00_ACLK] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_capture/S00_ACLK] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins axi_ic_capture/S01_ACLK] -boundary_type upper
  ...
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins capture_pipeline_0/aclk] -boundary_type upper
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins ${::PS_INST}/maxihpm0_fpd_aclk] [get_bd_pins capture_pipeline_1/aclk] -boundary_type upper
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_audio_mcu/ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_ctrl_300/ARESETN] -boundary_type upper
  # connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_ctrl_300/ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_accel_ctrl/ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_300MHz/interconnect_aresetn] [get_bd_pins axi_ic_capture/ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_accel_ctrl/M00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_accel_ctrl/S00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_audio_mcu/M00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_audio_mcu/S00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_audio_mcu/S01_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_audio_mcu/S02_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_300/M00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_300/M01_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_300/S00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_capture/M00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_capture/S00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_ic_capture/S01_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins vcu/aresetn] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins capture_pipeline_0/aresetn] -boundary_type upper
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins capture_pipeline_1/aresetn] -boundary_type upper
  # connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_300MHz/peripheral_aresetn] [get_bd_pins axi_vip_0/aresetn] -boundary_type upper
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M01_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M02_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M03_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/M04_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100/S00_ARESETN] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins phigent_trigger/s_axi_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins capture_pipeline_0/lite_aresetn] -boundary_type upper
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins capture_pipeline_1/lite_aresetn] -boundary_type upper
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports xlconstant_0/dout] [get_bd_ports fan_en_b] -boundary_type upper
  ...
  connect_bd_net -net sensor_trigger [get_bd_pins phigent_trigger/trigger] [get_bd_ports sensor_trigger]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs capture_pipeline_0/mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0xB0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs capture_pipeline_0/resize_0/S_AXI_CONTROL/reg0] -force
  assign_bd_address -offset 0x80010000 -range 0x00002000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs capture_pipeline_1/mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0xB0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs capture_pipeline_1/resize_0/S_AXI_CONTROL/reg0] -force
  ...
  assign_bd_address -offset 0x80200000 -range 0x00100000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data] [get_bd_addr_segs phigent_trigger/S_AXI_CONTROL/reg0] -force

  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces capture_pipeline_0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::PS_INST}/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces capture_pipeline_1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::PS_INST}/SAXIGP2/HP0_DDR_LOW] -force
